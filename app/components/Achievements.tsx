const items = [
  {
    ...
    description: "Placeholder — add the hackathon name, theme, and team details here.",
  },
  {
    year: "2024",
    category: "Certification",
    title: "Cloud Practitioner",
    description: "Placeholder — add the certification provider, score, and date obtained.",
  },
  {
    year: "2023",
    category: "Award",
    title: "Dean's List Recognition",
    description: "Placeholder — add the semester, GPA, and any additional context.",
  },
  {
    year: "2023",
    category: "Hackathon",
    title: "Smart India Hackathon",
    description: "Placeholder — add the problem statement, round reached, and outcome.",
  },
  {
    year: "2022",
    category: "Certification",
    title: "Associate Developer Certificate",
    description: "Placeholder — add the certification provider and skills covered.",
  },
];
