export default function CodeMatrix() {
  const platforms = [
    { name: "LeetCode", handle: "@Vvhq82c4cV", href: "https://leetcode.com/u/Vvhq82c4cV/", dot: "bg-orange-400", metrics: [{ label: "Problems Solved", value: "6" }, { label: "Easy Solved", value: "6" }, { label: "Global Rank", value: "~5,000,000" }, { label: "Max Streak", value: "2" }] },
