...
export default function StatsDashboard() {
  const [stats, setStats] = useState([
    { label: "Total Submissions", value: 0, target: 7, icon: GitCommit, color: "from-blue-400 to-cyan-500" },
    { label: "Problems Solved", value: 0, target: 12, icon: Code, color: "from-purple-400 to-pink-500" },
    { label: "HackerRank Stars", value: 0, target: 1, icon: Trophy, color: "from-yellow-400 to-orange-500" },
    { label: "Max Streak", value: 0, target: 2, icon: Flame, color: "from-red-400 to-rose-500" },
  ]);
    ...
    <section className="py-20 px-4">
      <div className="container mx-auto">
        ...
        >
          ...
          <p className="text-foreground/60">Real stats from Codolio — actively growing.</p>
        </motion.div>
              ...
              <div className="mt-8 pt-8 border-t border-white/10">
                <div className="flex flex-wrap items-center justify-center gap-6 text-sm">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-foreground/70">Actively solving</span>
                  </div>
                  <div className="text-foreground/50">|</div>
                  <a href="https://codolio.com/profile/C%20RYTHAN" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-blue-300 transition-colors font-medium">
