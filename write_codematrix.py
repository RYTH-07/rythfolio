...
export default function CodeMatrix() {
  const [platforms, setPlatforms] = useState<Platform[]>([
    { name: "LeetCode", handle: "@Vvhq82c4cV", href: "https://leetcode.com/u/Vvhq82c4cV/", dot: "bg-orange-400", metrics: [{ label: "Problems Solved", value: "..." }, { label: "Easy Solved", value: "..." }, { label: "Global Rank", value: "..." }, { label: "Max Streak", value: "..." }] },
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6">
        <div className="mb-12">
          ...
          <p className="mt-3 text-gray-500 dark:text-gray-400 max-w-lg">
            Competitive programming statistics across major platforms — updated live from APIs.
          </p>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
          {platforms.map((platform) => (
              ...
              className="rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-950 p-6 hover:shadow-md hover:border-blue-300 dark:hover:border-blue-700 transition-all block"
            >
        ...
        <p className="mt-6 text-xs text-gray-400 dark:text-gray-500 text-center">
          Click any card to view full profile — LeetCode stats update automatically
        </p>
      </div>
    </section>
  );
